            ...
            <div className="container grid grid-cols-1 gap-6 mx-auto sm:grid-cols-2 xl:grid-cols-4">
                <Link to={`/filter-by-category/Technology`}>
                    <div className="flex p-4 space-x-4 rounded-lg md:space-x-6 dark:bg-gray-400 dark:text-gray-800 justify-center">
                        ...
                        <div className="flex flex-col justify-center align-middle">
                            <p className="text-3xl font-semibold leading-none">Technology</p>
                ...
                <Link to={`/filter-by-category/Science`}>
                    <div className="flex p-4 space-x-4 rounded-lg md:space-x-6 dark:bg-gray-400 dark:text-gray-800 justify-center">
                        ...
                        <div className="flex flex-col justify-center align-middle">
                            <p className="text-3xl font-semibold leading-none">Science</p>
                ...
                <Link to={`/filter-by-category/Sports`}>
                    <div className="flex p-4 space-x-4 rounded-lg md:space-x-6 dark:bg-gray-400 dark:text-gray-800 justify-center">
                        ...
                        <div className="flex flex-col justify-center align-middle">
                            <p className="text-3xl font-semibold leading-none">Sports</p>
                ...
                <Link to={`/filter-by-category/Politics`}>
                    <div className="flex p-4 space-x-4 rounded-lg md:space-x-6 dark:bg-gray-400 dark:text-gray-800 justify-center">
                        ...
                        <div className="flex flex-col justify-center align-middle">
                            <p className="text-3xl font-semibold leading-none">Politics</p>
                            <p className="capitalize">Growth</p>
                        </div>
                    </div>
                </Link>
